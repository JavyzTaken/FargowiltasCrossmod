...
namespace FargowiltasCrossmod.Content.Calamity.Bosses.ExoMechs.FightManagers
{
    ...
    /// <param name="TotalActiveMechs">The amount of currently active Exo Mechs in the fight.</param>
    ...
    public record ExoMechFightState(DraedonEternity.DraedonAIState? DraedonState, int TotalActiveMechs, ExoMechState InitialMechState, params ExoMechState[] OtherMechsStates)
    {
        /// <summary>
