...
namespace FargowiltasCrossmod.Content.Thorium.Projectiles
{
    ...
    public class LodeStonePlatform : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            float orbitRadius = player.ForceEffect<LodestoneEffect>() ? 100 : 80;
            ...
            if (player.dead || !player.active || !player.HasEffect<LodestoneEffect>() || !modPlayer.LodeStonePlatforms.Contains(Projectile.whoAmI))
            {
                Projectile.Kill();
            }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Player player = Main.player[Projectile.owner];
            Rectangle rect = new(0, player.ForceEffect<LodestoneEffect>() ? 32 : 0, 60, 32);
    ...
    public class LodeStoneHeldSentry : GlobalProjectile
    {
        ...
        public override void OnSpawn(Projectile projectile, IEntitySource source)
        {
            ...
            {
                var modPlayer = player.ThoriumDLC();
                if (!player.HasEffect<LodestoneEffect>()) return;
