    ...
    public class CalDLCNPCChanges : GlobalNPC
    {
        ...
        public override void GetChat(NPC npc, ref string chat)
        {
            if (npc.type == ModContent.NPCType<DILF>())
            {
                ...
                {
                    chat = Language.GetTextValue("Mods.FargowiltasCrossmod.Chats.PermafrostChat1");
                    PermafrostDefeatLine = 0;
                }
                if (PermafrostDefeatLine == 2)
                {
                    chat = Language.GetTextValue("Mods.FargowiltasCrossmod.Chats.PermafrostChat2");
                    PermafrostDefeatLine = 0;
                }
            }
        }
        public override void ModifyShop(NPCShop shop)
        {
            ...
            Condition killedMauler = new Condition("Mods.FargowiltasCrossmod.Conditions.MaulerDowned", () => CalDLCCompatibilityMisc.DownedMauler);
            Condition killedNuclear = new Condition("Mods.FargowiltasCrossmod.Conditions.NuclearTerrorDowned", () => CalDLCCompatibilityMisc.DownedNuclear);
            Condition killedGSS = new Condition("Mods.FargowiltasCrossmod.Conditions.GreatSandSharkDowned", () => CalDLCCompatibilityMisc.DownedGSS);
