...
namespace FargowiltasCrossmod.Core.Calamity.Systems
{
    ...
    public class CalamityAIOverride : ModSystem
    {
        ...
        private static readonly MethodInfo CalamityPreDrawMethod = typeof(CalamityGlobalNPC).GetMethod("PreDraw", FargoSoulsUtil.UniversalBindingFlags);
        private static readonly MethodInfo CalamityPostDrawMethod = typeof(CalamityGlobalNPC).GetMethod("PostDraw", FargoSoulsUtil.UniversalBindingFlags);
        ...
        internal static bool CalamityPreDraw_Detour(Orig_CalamityPreDraw orig, CalamityGlobalNPC self, NPC npc, SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            bool shouldDisable = DLCCalamityConfig.Instance.EternityPriorityOverRev && WorldSavingSystem.EternityMode && shouldDisableNPC;
